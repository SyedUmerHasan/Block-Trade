...
var a2a = a2a || {
        ...
        for (var $ = 0; $ < b; $++) {
            ...
            if (Q && !g(Q, ["google_plus", "stumbleupon"]) && !ce) {
                if (K || (V.target = ne, !k || !r[Q] && d(Q, !0) ? "feed" == Q ? V.href = V.href || o.linkurl : (V.href = "/#" + Q, "js" === re ? a2a.add_event(V, "click", m) : (a2a.add_event(V, "mousedown", m), a2a.add_event(V, "keydown", m)), V.rel = "nofollow" + te) : V.href = (t = Q, l = n = void 0, i = u(a = V, {})["a2a-follow"], l = r[t], i && l && (n = l.url.replace("${id}", i)), n || a.href), V.a2a = {}, V.a2a.customserviceuri = se, V.a2a.stype = re, V.a2a.linkurl = o.linkurl, V.a2a.servicename = ae, V.a2a.safename = Q, le.src && (V.a2a.js_src = le.src), le.url && (V.a2a.url = le.url), le.pu && (V.a2a.popup = 1), le.media && (V.a2a.media = 1), h.a2a_codes = h.a2a_codes || [], h.a2a_codes.push(Q), k || a2a.add_event(V, "click", function(r, s, c, d, u) {
                    ...
                    if (!G) {
                        for (var ve in (U = document.createElement("span")).className = M + ie + " a2a_img_text", oe && (U.style.backgroundColor = "#" + oe), "pending" !== (W = a2a.svg.get(ie, U, N)) && (U.innerHTML = W), j) U.style[ve] = j[ve];
                        V.insertBefore(U, Z[0])
                    }
                } else {
                    for (var ve in (U = document.createElement("span")).className = M + ie, oe && (U.style.backgroundColor = "#" + oe), "pending" !== (W = a2a.svg.get(ie, U, N)) && (U.innerHTML = W), j) U.style[ve] = j[ve];
    ...
    counters: {
        get: function(i, o, e, l) {
            a2a_config.counts;
            var r, a, t = decodeURIComponent(e),
                n = a2a.counters.bonus(i, t, e, o.a2a.kit),
                s = "",
                c = a2a.counters[i],
                d = c.api,
                u = (c.cb, o.a2a.is_a2a_dd_counter);
            !l && n && (s = "2", a2a.counters.get(i, o, n, !0)), "string" != typeof(r = c[t] = c[t] || {}).num || l ? "number" != typeof r.num ? (r.queued = r.queued || [], r.queued.push(o), c.n = c.n || 0, c.n++, c["cb" + c.n] = function(e) {
                var a, t = a2a.counters[i].cb(e, o);
                if (void 0 !== t) {
                    if ("string" == typeof t && "facebook" == i) return "empty" == t ? a = "Note: Facebook no longer provides public API access to share counts. AddToAny is soon launching a premium service to manage private API access to Facebook and display share counts." : "limit" == t && (a = "Facebook's public share counts API has reached its request limit from your connection. Try again later."), console && "function" == typeof console.log && console.log("%c" + a, "color:#1877f2"), l || (o.style.display = "none"), void(r.num = "error");
            ...
            }, 1 == r.queued.length && (a = d[0] + e + (d[1] || "&callback") + "=a2a.counters." + i + ".cb" + c.n, a2a.dom.ready(function() {
                a2a.loadExtScript(a)
    ...
    show_full: function() {
        ...
        a2a.fill_menus(e), a2a.overlay.show(), a2a.animate("show", i), l.style.cssText = "height:calc(10px)", l.style.height.length && (l.style.height = "calc(100% - " + (o.offsetHeight + r.offsetHeight) + "px)"), i.focus(), a2a.stats("full")
    },
