                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Interior Color</span></h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="{{ route('portal') }}">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{ route('interiorcolor.getall') }}">Interior Color</a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{ route('interiorcolor.edit', $interiorcolor->id) }}">Edit</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="col s12 m12 l12">
                                <div id="button-trigger" class="card card card-default scrollspy">
                                    <div class="card-content">
                                        <h4 class="card-title">Edit Interior Color</h4>
                                        <div class="row">
                                            <div class="col s12">
                                            ...
                                            @endif
                                                ...
                                                <div class="row">
                                                    <form class="col s12" action="{{ route('interiorcolor.update', $interiorcolor->id) }}" method="POST">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="input-field col s12">
                                                                <input type="text" class="form-control" id="color_name" name="color_name" aria-describedby="helpId"  value="{{ $interiorcolor->color_name }}" >
                                                                <label for="color_name">Enter Interior Color Name</label>
                                                            </div>
                                                        </div>
                                                        <div class=" right">
