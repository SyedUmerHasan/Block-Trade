                    ...
                    <div class="row">
                        <div class="col s10 m6 l6">
                            ...
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('interiorcolor.create') }}">Interior Color</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="col s12 m12 l12">
                                <div id="button-trigger" class="card card card-default scrollspy">
                                    <div class="card-content">
                                        <h4 class="card-title">Create Interior Color</h4>
                                        <div class="row">
                                            <div class="col s12">
                                            ...
                                            @endif
                                                ...
                                                <div class="row">
                                                    <form class="col s12" action="{{ route('interiorcolor.add') }}" method="POST">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="input-field col s12">
                                                                <input type="text" class="form-control" id="color_name" name="color_name" aria-describedby="helpId"  >
