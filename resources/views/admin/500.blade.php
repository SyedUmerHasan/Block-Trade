...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/admin-assets/app-assets/css/themes/vertical-modern-menu-template/materialize.css">
    <link rel="stylesheet" type="text/css" href="/admin-assets/app-assets/css/themes/vertical-modern-menu-template/style.css">
    <link rel="stylesheet" type="text/css" href="/admin-assets/app-assets/css/pages/page-404.css">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
        ...
        <div class="container"><div class="section section-404 p-0 m-0 height-100vh">
          <div class="row">
            <div class="col s12 center-align white">
              ...
              <a class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4" href="{{ route('home') }}">Back To Home</a>
            </div>
          </div>
        </div>
        </div>
