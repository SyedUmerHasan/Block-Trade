                    ...
                    <div class="row">
                        <div class="col s10 m6 l6">
                            ...
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('automotive.manufacturer.update', $vehiclebrand->id) }}">Edit</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div id="button-trigger" class="card card card-default scrollspy">
                                    <div class="card-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <form class="col s12" action="{{ route('automotive.manufacturer.update', $vehiclebrand->id) }}" method="POST">
                                                    @csrf
                                                    <div class="row">
