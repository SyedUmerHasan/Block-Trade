                    ...
                    <div class="row">
                        <div class="col s10 m6 l6">
                            ...
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('exteriorcolor.edit',$exteriorcolor->id) }}">Edit</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="row">
                                            ...
                                            @endif
                                                ...
                                                <div class="row">
                                                    <form class="col s12" action="{{ route('exteriorcolor.update', $exteriorcolor->id) }}" method="POST">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="input-field col s12">
                                                                <input type="text" class="form-control" id="color_name" name="color_name" aria-describedby="helpId" value="{{ $exteriorcolor->color_name }}" >
                                                                <label for="color_name">Enter Exterior Color Name</label>
                                                            </div>
                                                        </div>
                                                        <div class=" right">
