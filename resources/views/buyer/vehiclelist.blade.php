            ...
            <script>
                ...
                window.addEventListener('load', async () => {
                    ...
                    if (networkData) {
                        ...
                        console.log("🚀 ~ file: vehiclelist.blade.php ~ line 120 ~ window.addEventListener ~ productCount", productCount)
                        var products = [];
                ...
                $("#addProducts").click(async (event)=>{
                    ...
                    const accounts = await web3.eth.getAccounts()
                    account = accounts[0]
                    console.log("🚀 ~ file: vehiclelist.blade.php ~ line 162 ~ $ ~ account", account)
                    const weiprice = window.web3.utils.toWei(price, 'Ether')
                    console.log("🚀 ~ file: vehiclelist.blade.php ~ line 157 ~ $ ~ weiprice", weiprice)
